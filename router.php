...
} else if (match_routes($request_uri, '/connecting-alumni')) {
  require 'pages/connect.php';
} else if (match_routes($request_uri, '/thanks-and-recognition')) {
  require 'pages/thanks.php';
} else if (match_routes($request_uri, '/joining-the-network')) {
  require 'pages/join.php';
} else if (match_routes($request_uri, '/connecting-alumni/person')) {
